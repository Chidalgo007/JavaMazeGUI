    ...
    public void cleanNoise() {
        ...
        for (int i = 1; i < hight - 1; i++) {
            for (int j = 1; j < width - 1; j++) {
                ...
                SortArray i_r = new SortArray(intensity_r);
                SortArray i_b = new SortArray(intensity_b);
                SortArray i_g = new SortArray(intensity_g);
                ...
                int size = (Integer)i_r.array.length;
                int n = (int)Math.floor(size/2.0);

                intensity_r[4] = (Integer) i_r.array[n];
                intensity_g[4] = (Integer) i_g.array[n];
                intensity_b[4] = (Integer) i_b.array[n];
